...
var _malloc, _free, _ma_device__on_notification_unlocked, _ma_malloc_emscripten, _ma_free_emscripten, _ma_device_process_pcm_frames_capture__webaudio, _ma_device_process_pcm_frames_playback__webaudio, _wgpuDeviceAddRef, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnCreateComputePipelineCompleted, _emwgpuOnMapAsyncCompleted, _emwgpuOnWorkDoneCompleted, ___getTypeName, _emscripten_builtin_memalign, _memalign, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_vi, dynCall_v, dynCall_vii, dynCall_ii, dynCall_iii, dynCall_iiii, dynCall_viii, dynCall_i, dynCall_fi, dynCall_fii, dynCall_vif, dynCall_viif, dynCall_dii, dynCall_viid, dynCall_iiiiiiii, dynCall_viiiiiii, dynCall_viiii, dynCall_iiiii, dynCall_viiiii, dynCall_iiijj, dynCall_iijj, dynCall_viijj, dynCall_iiiiii, dynCall_jiii, dynCall_viiij, dynCall_viiiiiiiii, dynCall_jiji, dynCall_vijj, dynCall_ji, dynCall_jij, dynCall_iiiijij, dynCall_jiij, dynCall_jii, dynCall_vij, dynCall_viij, dynCall_iij, dynCall_viiiiiiii, dynCall_iiji, dynCall_iiiiiiiii, dynCall_iiiiiii, dynCall_iiiji, dynCall_ff, dynCall_fff, dynCall_viiiiii, dynCall_iiiiiiiiiii, dynCall_iiiiiiiiiiii, dynCall_iiiiiiiiiiiii, dynCall_iiif, dynCall_iiiiiiiiii, dynCall_iiiiiiiiiiiiiii, dynCall_viiiiiiiiii, dynCall_viiiiiiiiiii, dynCall_viji, dynCall_viijii, dynCall_viiif, dynCall_viiifiii, dynCall_fiif, dynCall_iiiifi, dynCall_iiiifiii, dynCall_iiifi, dynCall_viiiif, dynCall_viiiifii, dynCall_iiiijj, dynCall_viiijjj, dynCall_viifii, dynCall_vfiii, dynCall_jjj, dynCall_fiii, dynCall_viiiffii, dynCall_iiiiiffi, dynCall_viiiiiff, dynCall_viiiiiiiiiiiii, dynCall_viiiiiiiiiiii, dynCall_viiiiiiiiiiiiiiiii, dynCall_iifff, dynCall_iiff, dynCall_iiifiii, dynCall_iiffi, dynCall_iiffii, dynCall_viiiiiiiiiiiiii, dynCall_iif, dynCall_vifi, dynCall_vidi, dynCall_vijjj, dynCall_vj, dynCall_iidiiiii, dynCall_iiiiij, dynCall_iiiiid, dynCall_iiiiijj, dynCall_iiiiiijj, _asyncify_start_unwind, _asyncify_stop_unwind, _asyncify_start_rewind, _asyncify_stop_rewind, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildFdoProfileChangelistStr, _kVersionStampBuildMemprofProfileChangelistStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory;

function assignWasmExports(wasmExports) {
  _malloc = Module["_malloc"] = wasmExports["pc"];
  _free = Module["_free"] = wasmExports["qc"];
  _ma_device__on_notification_unlocked = Module["_ma_device__on_notification_unlocked"] = wasmExports["rc"];
  _ma_malloc_emscripten = Module["_ma_malloc_emscripten"] = wasmExports["sc"];
  _ma_free_emscripten = Module["_ma_free_emscripten"] = wasmExports["tc"];
  _ma_device_process_pcm_frames_capture__webaudio = Module["_ma_device_process_pcm_frames_capture__webaudio"] = wasmExports["uc"];
  _ma_device_process_pcm_frames_playback__webaudio = Module["_ma_device_process_pcm_frames_playback__webaudio"] = wasmExports["vc"];
  _wgpuDeviceAddRef = wasmExports["wc"];
  _emwgpuCreateBindGroup = wasmExports["xc"];
  _emwgpuCreateBindGroupLayout = wasmExports["yc"];
  _emwgpuCreateCommandBuffer = wasmExports["zc"];
  _emwgpuCreateCommandEncoder = wasmExports["Ac"];
  _emwgpuCreateComputePassEncoder = wasmExports["Bc"];
  _emwgpuCreateComputePipeline = wasmExports["Cc"];
  _emwgpuCreateExternalTexture = wasmExports["Dc"];
  _emwgpuCreatePipelineLayout = wasmExports["Ec"];
  _emwgpuCreateQuerySet = wasmExports["Fc"];
  _emwgpuCreateRenderBundle = wasmExports["Gc"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["Hc"];
  _emwgpuCreateRenderPassEncoder = wasmExports["Ic"];
  _emwgpuCreateRenderPipeline = wasmExports["Jc"];
  _emwgpuCreateSampler = wasmExports["Kc"];
  _emwgpuCreateSurface = wasmExports["Lc"];
  _emwgpuCreateTexture = wasmExports["Mc"];
  _emwgpuCreateTextureView = wasmExports["Nc"];
  _emwgpuCreateAdapter = wasmExports["Oc"];
  _emwgpuImportBuffer = wasmExports["Pc"];
  _emwgpuCreateDevice = wasmExports["Qc"];
  _emwgpuCreateQueue = wasmExports["Rc"];
  _emwgpuCreateShaderModule = wasmExports["Sc"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Tc"];
  _emwgpuOnMapAsyncCompleted = wasmExports["Uc"];
  _emwgpuOnWorkDoneCompleted = wasmExports["Vc"];
  ___getTypeName = wasmExports["Xc"];
  _emscripten_builtin_memalign = wasmExports["Yc"];
  _memalign = wasmExports["Zc"];
  __emscripten_stack_restore = wasmExports["_c"];
  __emscripten_stack_alloc = wasmExports["$c"];
  _emscripten_stack_get_current = wasmExports["ad"];
  dynCall_vi = dynCalls["vi"] = wasmExports["bd"];
  dynCall_v = dynCalls["v"] = wasmExports["cd"];
  dynCall_vii = dynCalls["vii"] = wasmExports["dd"];
  dynCall_ii = dynCalls["ii"] = wasmExports["ed"];
  dynCall_iii = dynCalls["iii"] = wasmExports["fd"];
  dynCall_iiii = dynCalls["iiii"] = wasmExports["gd"];
  dynCall_viii = dynCalls["viii"] = wasmExports["hd"];
  dynCall_i = dynCalls["i"] = wasmExports["id"];
  dynCall_fi = dynCalls["fi"] = wasmExports["jd"];
  dynCall_fii = dynCalls["fii"] = wasmExports["kd"];
  dynCall_vif = dynCalls["vif"] = wasmExports["ld"];
  dynCall_viif = dynCalls["viif"] = wasmExports["md"];
  dynCall_dii = dynCalls["dii"] = wasmExports["nd"];
  dynCall_viid = dynCalls["viid"] = wasmExports["od"];
  dynCall_iiiiiiii = dynCalls["iiiiiiii"] = wasmExports["pd"];
  dynCall_viiiiiii = dynCalls["viiiiiii"] = wasmExports["qd"];
  dynCall_viiii = dynCalls["viiii"] = wasmExports["rd"];
  dynCall_iiiii = dynCalls["iiiii"] = wasmExports["sd"];
  dynCall_viiiii = dynCalls["viiiii"] = wasmExports["td"];
  dynCall_iiijj = dynCalls["iiijj"] = wasmExports["ud"];
  dynCall_iijj = dynCalls["iijj"] = wasmExports["vd"];
  dynCall_viijj = dynCalls["viijj"] = wasmExports["wd"];
  dynCall_iiiiii = dynCalls["iiiiii"] = wasmExports["xd"];
  dynCall_jiii = dynCalls["jiii"] = wasmExports["yd"];
  dynCall_viiij = dynCalls["viiij"] = wasmExports["zd"];
  dynCall_viiiiiiiii = dynCalls["viiiiiiiii"] = wasmExports["Ad"];
  dynCall_jiji = dynCalls["jiji"] = wasmExports["Bd"];
  dynCall_vijj = dynCalls["vijj"] = wasmExports["Cd"];
  dynCall_ji = dynCalls["ji"] = wasmExports["Dd"];
  dynCall_jij = dynCalls["jij"] = wasmExports["Ed"];
  dynCall_iiiijij = dynCalls["iiiijij"] = wasmExports["Fd"];
  dynCall_jiij = dynCalls["jiij"] = wasmExports["Gd"];
  dynCall_jii = dynCalls["jii"] = wasmExports["Hd"];
  dynCall_vij = dynCalls["vij"] = wasmExports["Id"];
  dynCall_viij = dynCalls["viij"] = wasmExports["Jd"];
  dynCall_iij = dynCalls["iij"] = wasmExports["Kd"];
  dynCall_viiiiiiii = dynCalls["viiiiiiii"] = wasmExports["Ld"];
  dynCall_iiji = dynCalls["iiji"] = wasmExports["Md"];
  dynCall_iiiiiiiii = dynCalls["iiiiiiiii"] = wasmExports["Nd"];
  dynCall_iiiiiii = dynCalls["iiiiiii"] = wasmExports["Od"];
  dynCall_iiiji = dynCalls["iiiji"] = wasmExports["Pd"];
  dynCall_ff = dynCalls["ff"] = wasmExports["Qd"];
  dynCall_fff = dynCalls["fff"] = wasmExports["Rd"];
  dynCall_viiiiii = dynCalls["viiiiii"] = wasmExports["Sd"];
  dynCall_iiiiiiiiiii = dynCalls["iiiiiiiiiii"] = wasmExports["Td"];
  dynCall_iiiiiiiiiiii = dynCalls["iiiiiiiiiiii"] = wasmExports["Ud"];
  dynCall_iiiiiiiiiiiii = dynCalls["iiiiiiiiiiiii"] = wasmExports["Vd"];
  dynCall_iiif = dynCalls["iiif"] = wasmExports["Wd"];
  dynCall_iiiiiiiiii = dynCalls["iiiiiiiiii"] = wasmExports["Xd"];
  dynCall_iiiiiiiiiiiiiii = dynCalls["iiiiiiiiiiiiiii"] = wasmExports["Yd"];
  dynCall_viiiiiiiiii = dynCalls["viiiiiiiiii"] = wasmExports["Zd"];
  dynCall_viiiiiiiiiii = dynCalls["viiiiiiiiiii"] = wasmExports["_d"];
  dynCall_viji = dynCalls["viji"] = wasmExports["$d"];
  dynCall_viijii = dynCalls["viijii"] = wasmExports["ae"];
  dynCall_viiif = dynCalls["viiif"] = wasmExports["be"];
  dynCall_viiifiii = dynCalls["viiifiii"] = wasmExports["ce"];
  dynCall_fiif = dynCalls["fiif"] = wasmExports["de"];
  dynCall_iiiifi = dynCalls["iiiifi"] = wasmExports["ee"];
  dynCall_iiiifiii = dynCalls["iiiifiii"] = wasmExports["fe"];
  dynCall_iiifi = dynCalls["iiifi"] = wasmExports["ge"];
  dynCall_viiiif = dynCalls["viiiif"] = wasmExports["he"];
  dynCall_viiiifii = dynCalls["viiiifii"] = wasmExports["ie"];
  dynCall_iiiijj = dynCalls["iiiijj"] = wasmExports["je"];
  dynCall_viiijjj = dynCalls["viiijjj"] = wasmExports["ke"];
  dynCall_viifii = dynCalls["viifii"] = wasmExports["le"];
  ...
  memory = wasmMemory = wasmExports["Fb"];
  _kVersionStampBuildChangelistStr = Module["_kVersionStampBuildChangelistStr"] = (wasmExports["Hb"].value) >>> 0;
  _kVersionStampCitcSnapshotStr = Module["_kVersionStampCitcSnapshotStr"] = (wasmExports["Ib"].value) >>> 0;
  _kVersionStampCitcWorkspaceIdStr = Module["_kVersionStampCitcWorkspaceIdStr"] = (wasmExports["Jb"].value) >>> 0;
  _kVersionStampSourceUriStr = Module["_kVersionStampSourceUriStr"] = (wasmExports["Kb"].value) >>> 0;
  _kVersionStampBuildClientStr = Module["_kVersionStampBuildClientStr"] = (wasmExports["Lb"].value) >>> 0;
  _kVersionStampBuildClientMintStatusStr = Module["_kVersionStampBuildClientMintStatusStr"] = (wasmExports["Mb"].value) >>> 0;
  _kVersionStampBuildCompilerStr = Module["_kVersionStampBuildCompilerStr"] = (wasmExports["Nb"].value) >>> 0;
  _kVersionStampBuildDateTimePstStr = Module["_kVersionStampBuildDateTimePstStr"] = (wasmExports["Ob"].value) >>> 0;
  _kVersionStampBuildDepotPathStr = Module["_kVersionStampBuildDepotPathStr"] = (wasmExports["Pb"].value) >>> 0;
  _kVersionStampBuildIdStr = Module["_kVersionStampBuildIdStr"] = (wasmExports["Qb"].value) >>> 0;
  _kVersionStampBuildInfoStr = Module["_kVersionStampBuildInfoStr"] = (wasmExports["Rb"].value) >>> 0;
  _kVersionStampBuildLabelStr = Module["_kVersionStampBuildLabelStr"] = (wasmExports["Sb"].value) >>> 0;
  _kVersionStampBuildTargetStr = Module["_kVersionStampBuildTargetStr"] = (wasmExports["Tb"].value) >>> 0;
  _kVersionStampBuildTimestampStr = Module["_kVersionStampBuildTimestampStr"] = (wasmExports["Ub"].value) >>> 0;
  _kVersionStampBuildToolStr = Module["_kVersionStampBuildToolStr"] = (wasmExports["Vb"].value) >>> 0;
  _kVersionStampG3BuildTargetStr = Module["_kVersionStampG3BuildTargetStr"] = (wasmExports["Wb"].value) >>> 0;
  _kVersionStampVerifiableStr = Module["_kVersionStampVerifiableStr"] = (wasmExports["Xb"].value) >>> 0;
  _kVersionStampBuildFdoTypeStr = Module["_kVersionStampBuildFdoTypeStr"] = (wasmExports["Yb"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistStr = Module["_kVersionStampBuildBaselineChangelistStr"] = (wasmExports["Zb"].value) >>> 0;
  _kVersionStampBuildLtoTypeStr = Module["_kVersionStampBuildLtoTypeStr"] = (wasmExports["_b"].value) >>> 0;
  _kVersionStampBuildPropellerTypeStr = Module["_kVersionStampBuildPropellerTypeStr"] = (wasmExports["$b"].value) >>> 0;
  _kVersionStampBuildPghoTypeStr = Module["_kVersionStampBuildPghoTypeStr"] = (wasmExports["ac"].value) >>> 0;
  _kVersionStampBuildFdoProfileChangelistStr = Module["_kVersionStampBuildFdoProfileChangelistStr"] = (wasmExports["bc"].value) >>> 0;
  _kVersionStampBuildMemprofProfileChangelistStr = Module["_kVersionStampBuildMemprofProfileChangelistStr"] = (wasmExports["cc"].value) >>> 0;
  _kVersionStampBuildUsernameStr = Module["_kVersionStampBuildUsernameStr"] = (wasmExports["dc"].value) >>> 0;
  _kVersionStampBuildHostnameStr = Module["_kVersionStampBuildHostnameStr"] = (wasmExports["ec"].value) >>> 0;
  _kVersionStampBuildDirectoryStr = Module["_kVersionStampBuildDirectoryStr"] = (wasmExports["fc"].value) >>> 0;
  _kVersionStampBuildChangelistInt = Module["_kVersionStampBuildChangelistInt"] = (wasmExports["gc"].value) >>> 0;
  _kVersionStampCitcSnapshotInt = Module["_kVersionStampCitcSnapshotInt"] = (wasmExports["hc"].value) >>> 0;
  _kVersionStampBuildClientMintStatusInt = Module["_kVersionStampBuildClientMintStatusInt"] = (wasmExports["ic"].value) >>> 0;
  _kVersionStampBuildTimestampInt = Module["_kVersionStampBuildTimestampInt"] = (wasmExports["jc"].value) >>> 0;
  _kVersionStampVerifiableInt = Module["_kVersionStampVerifiableInt"] = (wasmExports["kc"].value) >>> 0;
  _kVersionStampBuildCoverageEnabledInt = Module["_kVersionStampBuildCoverageEnabledInt"] = (wasmExports["lc"].value) >>> 0;
  _kVersionStampBuildBaselineChangelistInt = Module["_kVersionStampBuildBaselineChangelistInt"] = (wasmExports["mc"].value) >>> 0;
  _kVersionStampPrecookedTimestampStr = Module["_kVersionStampPrecookedTimestampStr"] = (wasmExports["nc"].value) >>> 0;
  _kVersionStampPrecookedClientInfoStr = Module["_kVersionStampPrecookedClientInfoStr"] = (wasmExports["oc"].value) >>> 0;
  __indirect_function_table = wasmExports["__indirect_function_table"];
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = (wasmExports["Wc"].value) >>> 0;
}

var wasmImports = {
  /** @export */ Db: DefaultErrorReporter,
  /** @export */ Cb: GetAdapterArchitecture,
  /** @export */ Bb: GetAdapterDescription,
  /** @export */ Ab: GetAdapterDeviceName,
  /** @export */ zb: GetAdapterVendor,
  /** @export */ yb: JsGetDeviceMaxSubgroupSize,
  /** @export */ xb: JsGetDeviceMinSubgroupSize,
  /** @export */ wb: ThrowError,
  /** @export */ vb: __Unwind_RaiseException,
  /** @export */ Eb: __asyncjs__CallStreamWeightsOnWeb,
  /** @export */ R: __asyncjs__ReadBufferDataJs,
  /** @export */ ub: ___syscall_dup,
  /** @export */ tb: ___syscall_faccessat,
  /** @export */ t: ___syscall_fcntl64,
  /** @export */ sb: ___syscall_fstat64,
  /** @export */ rb: ___syscall_ftruncate64,
  /** @export */ qb: ___syscall_getcwd,
  /** @export */ pb: ___syscall_getdents64,
  /** @export */ ob: ___syscall_getuid32,
  /** @export */ nb: ___syscall_ioctl,
  /** @export */ mb: ___syscall_lstat64,
  /** @export */ lb: ___syscall_mkdirat,
  /** @export */ kb: ___syscall_newfstatat,
  /** @export */ Q: ___syscall_openat,
  /** @export */ jb: ___syscall_readlinkat,
  /** @export */ ib: ___syscall_rmdir,
  /** @export */ hb: ___syscall_stat64,
  /** @export */ ga: ___syscall_unlinkat,
  /** @export */ gb: ___syscall_utimensat,
  /** @export */ _a: __abort_js,
  /** @export */ A: __embind_finalize_value_object,
  /** @export */ ea: __embind_register_bigint,
  /** @export */ Za: __embind_register_bool,
  ...
  /** @export */ Ya: __embind_register_emval,
  /** @export */ da: __embind_register_enum,
  /** @export */ r: __embind_register_enum_value,
  /** @export */ ca: __embind_register_float,
  /** @export */ ba: __embind_register_function,
  ...
  /** @export */ Xa: __embind_register_smart_ptr,
  /** @export */ Wa: __embind_register_std_string,
  ...
  /** @export */ Va: __embind_register_void,
  /** @export */ aa: __emval_await,
  ...
  /** @export */ fb: _clock_time_get,
  /** @export */ Na: custom_emscripten_dbgn,
  /** @export */ $: _emscripten_asm_const_int,
  /** @export */ O: _emscripten_errn,
  /** @export */ Ma: _emscripten_get_heap_max,
  /** @export */ j: _emscripten_get_now,
  /** @export */ _: _emscripten_has_asyncify,
  ...
  /** @export */ Y: _emscripten_stack_snapshot,
  /** @export */ Ia: _emscripten_stack_unwind_buffer,
  /** @export */ X: _emscripten_webgpu_get_device,
  /** @export */ Ha: _emwgpuBufferDestroy,
  /** @export */ Ga: _emwgpuBufferGetConstMappedRange,
  /** @export */ Fa: _emwgpuBufferGetMappedRange,
  /** @export */ Ea: _emwgpuBufferMapAsync,
  /** @export */ Da: _emwgpuBufferUnmap,
  /** @export */ Ca: _emwgpuBufferWriteMappedRange,
  /** @export */ k: _emwgpuDelete,
  /** @export */ Ba: _emwgpuDeviceCreateBuffer,
  /** @export */ Aa: _emwgpuDeviceCreateComputePipelineAsync,
  /** @export */ za: _emwgpuDeviceCreateShaderModule,
  /** @export */ ya: _emwgpuDeviceDestroy,
  /** @export */ xa: _emwgpuQueueOnSubmittedWorkDone,
  /** @export */ wa: _emwgpuWaitAny,
  /** @export */ eb: _environ_get,
  /** @export */ db: _environ_sizes_get,
  /** @export */ W: _exit,
  /** @export */ B: _fd_close,
  /** @export */ cb: _fd_pread,
  /** @export */ fa: _fd_read,
  ...
  /** @export */ ab: _proc_exit,
  /** @export */ $a: _random_get,
  /** @export */ M: _wgpuBufferGetSize,
  /** @export */ va: _wgpuBufferGetUsage,
  /** @export */ p: _wgpuCommandEncoderBeginComputePass,
  /** @export */ L: _wgpuCommandEncoderClearBuffer,
  /** @export */ v: _wgpuCommandEncoderCopyBufferToBuffer,
  /** @export */ ua: _wgpuCommandEncoderCopyBufferToTexture,
  /** @export */ ta: _wgpuCommandEncoderCopyTextureToBuffer,
  /** @export */ sa: _wgpuCommandEncoderCopyTextureToTexture,
  /** @export */ f: _wgpuCommandEncoderFinish,
  /** @export */ ra: _wgpuCommandEncoderResolveQuerySet,
  /** @export */ q: _wgpuComputePassEncoderDispatchWorkgroups,
  /** @export */ o: _wgpuComputePassEncoderEnd,
  /** @export */ V: _wgpuComputePassEncoderSetBindGroup,
  /** @export */ K: _wgpuComputePassEncoderSetPipeline,
  /** @export */ qa: _wgpuComputePipelineGetBindGroupLayout,
  /** @export */ U: _wgpuDeviceCreateBindGroup,
  /** @export */ pa: _wgpuDeviceCreateBindGroupLayout,
  /** @export */ e: _wgpuDeviceCreateCommandEncoder,
  /** @export */ J: _wgpuDeviceCreateComputePipeline,
  /** @export */ oa: _wgpuDeviceCreatePipelineLayout,
  /** @export */ na: _wgpuDeviceCreateQuerySet,
  /** @export */ ma: _wgpuDeviceCreateTexture,
  /** @export */ D: _wgpuDeviceGetAdapterInfo,
  /** @export */ la: _wgpuDeviceGetLimits,
  /** @export */ ka: _wgpuDeviceHasFeature,
  /** @export */ d: _wgpuQueueSubmit,
  /** @export */ I: _wgpuQueueWriteBuffer,
  /** @export */ ja: _wgpuQueueWriteTexture,
  /** @export */ ia: _wgpuTextureCreateView,
  /** @export */ ha: _wgpuTextureDestroy,
...
function applySignatureConversions(wasmExports) {
  ...
  wasmExports["pc"] = makeWrapper_pp(wasmExports["pc"]);
  ...
  wasmExports["ad"] = makeWrapper_p(wasmExports["ad"]);
  return wasmExports;
}
