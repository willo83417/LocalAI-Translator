  ...
  en: {
    translation: {
      ...
      settings: {
        ...
        enableOfflineAsrLabel: 'Offline speech recognition model',
        enableOfflineAsrDescription: 'Use this on-device model. Can be used with online or offline translation.',
        ...
        ttsTargetLangLabel: 'TTS Voice Language Filter',
      ...
      camera: {
        ...
        orientationAuto: 'Auto-Orient',
        orientationPortrait: 'Portrait (0°)',
        orientationLandscapeRight: 'Landscape (90°)',
        orientationLandscapeLeft: 'Landscape (270°)',
        rotateCw: 'Rotate 90° CW',
        rotateCcw: 'Rotate 90° CCW',
        framingGuide: 'Framing Guide',
        framingGuideNone: 'Standard (No Guide)',
        framingGuideDoc: 'Document Guide',
        framingGuideStrip: 'Strip / Small paper',
        cropToFrame: 'Crop to Guide',
        showOriginal: 'Full Image',
        retake: 'Retake',
        usePhoto: 'Use Photo',
  ...
  ja: {
    translation: {
      ...
      settings: {
        ...
        enableOfflineAsrLabel: 'オフライン音声認識モデル',
        enableOfflineAsrDescription: 'この端末モデルを使用します。オンラインまたはオフライン翻訳が可能です。',
        ...
        ttsTargetLangLabel: 'TTS 音声言語フィルター',
      ...
      camera: {
        ...
        captureAriaLabel: '画像をキャプチャして処理',
        processingAriaLabel: '画像を処理中',
        flashOffAriaLabel: 'フラッシュをオンにする',
        flashOnAriaLabel: 'フラッシュをオフにする',
        orientationAuto: '自動方向',
        orientationPortrait: '縦向き (0°)',
        orientationLandscapeRight: '横向き (90°)',
        orientationLandscapeLeft: '横向き (270°)',
        rotateCw: '時計回りに90°回転',
        rotateCcw: '反時計回りに90°回転',
        framingGuide: 'フレーミング枠',
        framingGuideNone: '標準 (枠なし)',
        framingGuideDoc: '文書フレーム',
        framingGuideStrip: '短冊・小さな枠',
        cropToFrame: '枠に合わせて切り抜き',
        showOriginal: '元の画像',
        retake: '再撮影',
        usePhoto: 'この写真を使用',
        orientationStatus: '撮影方向',
      },
      notifications: {
  ...
  'zh-TW': {
    translation: {
      ...
      settings: {
        ...
        enableOfflineAsrLabel: '離線語音辨識模型',
        enableOfflineAsrDescription: '使用本機端模型。可搭配線上或離線翻譯。',
      ...
      camera: {
        ...
        orientationAuto: '自動方向偵測',
        orientationPortrait: '直向 (0°)',
        orientationLandscapeRight: '橫向順時針 (90°)',
        orientationLandscapeLeft: '橫向逆時針 (270°)',
        rotateCw: '順時針旋轉 90°',
        rotateCcw: '逆時針旋轉 90°',
        framingGuide: '取景輔助框',
        framingGuideNone: '標準模式 (無取景輔助)',
        framingGuideDoc: '標準文件框',
        framingGuideStrip: '長條 / 小紙框',
        cropToFrame: '裁切至取景範圍',
        showOriginal: '完整圖片',
        retake: '重拍',
        usePhoto: '確認使用',
        orientationStatus: '手持方向',
      },
      notifications: {
